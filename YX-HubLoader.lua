...
local WHITELIST_FILE = "YX-卡密文件.json"
local VALIDATED_USERS_FILE = "YX-已验证卡密文件.json"
...
local function isUserValidated()
    ...
    if userData and userData.Validated then
        if (os.time() - userData.Time) < 5184000 then
            return true
        else
...
local function executeMainScript()
    ...
    local success, err = pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/YirdeX-Dev/scripts/refs/heads/main/YX-脚本中心.lua"))()
    end)
