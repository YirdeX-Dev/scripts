...
----------
local ScriptCenterLeftGroup = Tabs.ScriptCenter:AddLeftGroupbox("脚本中心1", "folder-open");
local ScriptCenterRightGroup = Tabs.ScriptCenter:AddRightGroupbox("脚本中心2", "folder-open");
local leftIndex = 0;
local rightIndex = 0;
